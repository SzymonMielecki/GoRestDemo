...
func PutPollution(a logic.AppState) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		time := time.Now()
		a.PutPollution(time, pollution)
		return c.String(http.StatusOK, "Pollution added")
	}
}

func PutWeather(a logic.AppState) echo.HandlerFunc {
	return func(c echo.Context) error {
